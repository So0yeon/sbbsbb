...
| `assets/` | 3D 모델 9점 · **사진 68장** · 저폴리 키트 · 지도 원본 | 에셋 |
...
0. **[MASTER.md](MASTER.md)** — **모든 문서를 합쳐 충돌을 해소한 최상위 기준.** 아래 문서와 어긋나면 이것이 맞습니다
...
| [02-MINIGAMES](docs/02-MINIGAMES.md) | 미니게임 10형식 메커닉과 정확한 상수 |
...
파일 이름이 곧 학습 항목 id 라서 그대로 이어 붙일 수 있습니다(46파일 = 학습 항목 **41개**).
나머지 22장(`hb_*`)은 아직 항목에 못 붙였고, 학습 항목 146개 중 **105개는 사진이 없습니다**.
**저작자와 라이선스는 [`assets/photos/CREDITS.md`](assets/photos/CREDITS.md) 에 있습니다.
CC BY-SA 사진은 저작자 이름을 그대로 표시해야 합니다.**

`assets/countries-50m.json` 은 Natural Earth **1:50m** 국가 경계 원본(739KB)입니다.
여기서 한반도 해안선을 뽑아 씁니다 — [07-ASSETS.md](docs/07-ASSETS.md) 4장.
**하천과 음영기복은 이 파일에 없습니다.** 스펙에서 뺐습니다 — [MASTER.md](MASTER.md) §7-2.
