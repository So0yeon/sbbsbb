...
(function (global) {
  ...
  /* ══════════════════════════════════════════════════════════════
     ...
     ══════════════════════════════════════════════════════════════ */
  var RANKS = [
    { i:0, icon:'👣', name:'아직 첫걸음 전',     at:0,   say:'가방과 수첩을 챙겼으니, 이제 한 걸음만 떼면 되오.' },
    { i:1, icon:'🐾', name:'설레는 첫걸음',       at:1,   say:'첫 발자국을 남겼구려. 여기서부터 길이 열리오.' },
    { i:2, icon:'🧭', name:'궁금한 길잡이',       at:10,  say:'묻는 것이 많아졌구려. 좋은 조짐이오.' },
    { i:3, icon:'🎒', name:'씩씩한 탐험가',       at:40,  say:'가방이 제법 묵직해졌소. 걸음에 힘이 붙었구려.' },
    { i:4, icon:'⏳', name:'슬기로운 시간여행자', at:100, say:'시대와 시대 사이를 제 발로 오가는구려.' },
    { i:5, icon:'📖', name:'든든한 역사지기',     at:180, say:'그대가 걸어온 길이 곧 한 권의 책이 되었소.' }
  ];
  ...
  /* ══════════════════════════════════════════════════════════════
     ...
     ══════════════════════════════════════════════════════════════ */
  var AXIS_META = {
    observe:   { icon:'👀', label:'관찰', adj:'차근차근 살펴보는',       noun:'관찰가',
                 desc:'그대는 서두르지 않고 오래 들여다보는 사람이오. 남이 지나친 자리에서 증거를 찾아내오.' },
    challenge: { icon:'🎮', label:'도전', adj:'겁 없이 부딪쳐 보는',     noun:'도전가',
                 desc:'그대는 손으로 직접 해 보아야 아는 사람이오. 실패해도 다시 잡는 손이 빠르오.' },
    story:     { icon:'💬', label:'이야기', adj:'사람의 말을 귀담아듣는', noun:'이야기꾼',
                 desc:'그대는 길에서 만난 이들의 말을 흘려듣지 않소. 역사를 사람의 일로 읽는 눈을 가졌소.' },
    collect:   { icon:'🏺', label:'수집', adj:'하나도 놓치지 않고 모으는', noun:'수집가',
                 desc:'그대는 흩어진 것을 한자리에 모아 놓고서야 마음이 놓이는 사람이오.' },
    travel:    { icon:'🗺️', label:'탐사', adj:'발로 뛰어 멀리 가 보는',  noun:'길잡이',
                 desc:'그대는 지도 끝까지 가 보아야 직성이 풀리는 사람이오. 넓게 보는 눈이 있소.' },
    write:     { icon:'✍️', label:'기록', adj:'생각을 글로 남기는',      noun:'기록가',
