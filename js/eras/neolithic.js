...
export const QUESTS_NEO_BASE = [
 ...
 },
 {
  ...
  "capstone": {
   "text": "가락바퀴와 뼈바늘이 함께 발견된다는 사실에서 무엇을 짐작할 수 있으겠소?",
   "choices": [
 ...
 },
 {
  ...
  "capstone": {
   "text": "갈판 가운데가 반질반질하게 닳아 있는 모습에서 무엇을 짐작할 수 있으겠소?",
   "choices": [
    "한두 번 쓰고 바로 버린 도구였다",
...
export const NPCS_NEO = [
 ...
 },
 {
  ...
  "lines": [
   ...
   "무늬 없이 밋밋한 그릇보다, 이렇게 정성껏 새긴 그릇이 훨씬 오래간다는 걸 저는 알소."
  ]
 },
 {
  "area": "main",
 ...
 },
 {
  ...
  "icon": "🧒",
  "lines": [
   "저기 나루터에 배 보이시다오? 아버지가 만드신 것이오. 저도 크면 배를 저어 보고 싶소.",
