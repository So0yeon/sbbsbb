...
export const NPCS_OPEN = [
 ...
 },
 {
  ...
  "icon": "💡",
  "lines": [
   "경복궁 건청궁에 처음 전등이 켜졌을 때 나도 구경을 갔다오.",
 ...
 },
 {
  ...
  "icon": "⚓",
  "lines": [
   "나는 부두에서 짐을 싣고 내리오. 항구가 열린 뒤로 배가 끊이지 않소.",
 ...
 },
 {
  ...
  "icon": "💰",
  "lines": [
   "나는 객주올시다. 외국 상인과 우리 상인 사이를 이어 주고 삯을 받는다오.",
 ...
 },
 {
  ...
  "icon": "📚",
  "lines": [
   "나는 신식 학교에 다니는 학생이오. 산수와 지리, 서양 말까지 배우오.",
   "몇 해 전만 해도 여자아이가 글을 배우는 건 생각도 못 할 일이었소.",
   "집에서는 아직도 못마땅해하시지만, 나는 배우는 게 참 좋소."
  ]
 },
 {
  "area": "jeongdong",
 ...
 },
 {
  ...
  "icon": "🖋️",
  "lines": [
   "조약을 맺던 자리에 나도 있었소. 글자 한 줄 한 줄이 그렇게 무거운 줄 몰랐소.",
